...
public class saveInformation //removing monobehavior since this won't be a component
{
    ...
    public bool town;
    public saveInformation(playerController controller, playerInventory inventory, interactionController interaction) //handing it the two scripts that will contain information
    {
